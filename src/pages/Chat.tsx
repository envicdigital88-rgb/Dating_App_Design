...
import { dayLabel, messageTime, presence } from '../utils/format';
...
export function Chat() {
  ...
  if (!conversation || !currentUser || !entitlements) return <Navigate to="/app/messages" replace />;
    ...
    <div className="flex h-[100dvh] flex-col bg-cream">
      ...
      <div className="border-t border-sand/70 bg-white px-3 py-3 pb-[calc(0.75rem+env(safe-area-inset-bottom))] sm:px-5">
          ...
          <div className="mb-2 flex flex-wrap gap-1 rounded-3xl border border-sand bg-cream p-2">
            ...
            `${entitlements.chatRemaining} messages remaining · each message you send uses one`}
            </p>
          </div>
        </div>
      }
