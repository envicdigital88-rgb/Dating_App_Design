...
import { lifestyleFields } from '../data/interests';
...
export function ProfileDetail() {
  ...
  if (!user || !currentUser || !entitlements) return <Navigate to="/app/discover" replace />;
  if (user.id === currentUser.id) return <Navigate to="/app/profile" replace />;
