  ...
  return (
    <Page>
      <PageHeader
        ...
        <Button variant="outline" onClick={() => router.push('/app/packages')}>
      ...
      <div className="grid gap-8 lg:grid-cols-[minmax(0,1fr)_300px]">
        <div className="mx-auto w-full max-w-xl lg:mx-0">
          ...
          <EmptyState
            ...
            action={<Button onClick={() => router.push('/app/likes')}>See who liked you</Button>} /> :
        ...
        <aside className="space-y-5">
          <div className="rounded-4xl bg-white p-5 shadow-card">
            ...
            {entitlements.subscriptionStatus === 'free' &&
            <Button size="sm" block className="mt-4" onClick={() => router.push('/app/packages')}>
                See packages
              </Button>
            }
          </div>
