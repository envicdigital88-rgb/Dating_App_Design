    ...
    <Page>
      ...
      <div className="max-w-3xl">
        ...
        <EmptyState
          ...
          action={<Button onClick={() => router.push('/app/photos')}>Review my photos</Button>} /> :
            ...
            return (
              <li
                ...
                className="flex flex-wrap items-center gap-4 rounded-4xl bg-white p-4 shadow-card sm:p-5">
                    ...
                    <button
                  onClick={() => router.push(`/app/profile/${sender.id}`)}
                  className="shrink-0"
      ...
      <div className="max-w-3xl">
        ...
        <EmptyState
          ...
          action={<Button onClick={() => router.push('/app/discover')}>Discover people</Button>} /> :
        ...
        <ul className="space-y-3">
            ...
            return (
              <li
                ...
                <Button size="sm" onClick={() => router.push('/app/messages')}>
                        Open chat
                      </Button>
                }
                  </li>);
