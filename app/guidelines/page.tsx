              ...
              <div className="space-y-12 text-[16px] leading-relaxed text-ink-soft/90">
                <section className="group">
                  <h2 className="text-2xl font-display font-semibold text-ink mb-4 flex items-center gap-3 transition-colors group-hover:text-berry-300">
                    <HeartHandshakeIcon className="h-6 w-6 text-berry-500" />
                    Respect and Kindness
                  </h2>
                  <div className="border-l-2 border-white/5 pl-6 py-1 ml-[1.125rem]">
                    <p className="mb-4">
                      Wingle Mingle is a community built on respect. We expect all our members to treat each other with kindness and empathy.
                    </p>
                    <p>
                      Harassment, bullying, hate speech, and inappropriate content are strictly prohibited and will result in immediate termination of your account.
                    </p>
                  </div>
                </section>
              </div>
