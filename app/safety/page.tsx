              ...
              <div className="space-y-12 text-[16px] leading-relaxed text-ink-soft/90">
                <section className="group">
                  <h2 className="text-2xl font-display font-semibold text-ink mb-4 flex items-center gap-3 transition-colors group-hover:text-berry-300">
                    <ShieldCheckIcon className="h-6 w-6 text-berry-500" />
                    Your Safety is our Priority
                  </h2>
                  <div className="border-l-2 border-white/5 pl-6 py-1 ml-[1.125rem]">
                    <p className="mb-4">
                      At Wingle Mingle, we believe that dating should be fun, exciting, and above all, safe. We have built robust systems to ensure your experience is positive and secure.
                    </p>
                    <p>
                      If you ever feel uncomfortable, please don't hesitate to use our reporting tools. Our moderation team is available 24/7 to review reports and take appropriate action.
                    </p>
                  </div>
                </section>
              </div>
