      ...
      {open && (
        <div className="fixed inset-0 z-50">
          <motion.div
            ...
            className="fixed inset-0 bg-plum-700/45 backdrop-blur-[2px]"
            onClick={onClose}
          />
          ...
          <div className="fixed inset-0 z-10 overflow-y-auto">
            <div className="flex min-h-full items-end justify-center p-0 sm:items-center sm:p-6">
              <motion.div
                ...
                className={`relative w-full ${maxWidth} rounded-t-4xl bg-cream-deep p-6 shadow-lift sm:rounded-4xl text-left`}
              >
                <button
                  onClick={onClose}
                  aria-label="Close"
